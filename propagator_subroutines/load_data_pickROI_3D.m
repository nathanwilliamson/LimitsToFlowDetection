function [Image_comp_s1,Image_roi_s1,bw_mat,dims,fov,mean_roi_s1,grad]=load_data_pickROI_3D(pathname,im_ind)
...
%         A1_s2(i-reco_ind(1)+1,:,:,:)=reshape(A_s2,[dims(1),dims(2),num_grad]);
        ...
        A1_s1(i-reco_ind(1)+1,:,:,:)=A1(i-reco_ind(1)+1,8,:,:,:); %s1 and s2 are slice 1 and 2
...
% figure
% imagesc(squeeze(Image_mag_s1(:,:,1)))
%  colormap(gray)
