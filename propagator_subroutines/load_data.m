function [Image_comp_s1,Image_comp_s2,Image_roi_s1,Image_roi_s2, mean_roi_s1,mean_roi_s2,grad]=load_data(pathname,im_ind, bw_mat)
...
%% store complex ROI data for every experimentz 
